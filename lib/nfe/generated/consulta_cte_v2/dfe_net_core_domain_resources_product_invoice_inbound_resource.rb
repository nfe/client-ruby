...
module Nfe
  module Generated
    module ConsultaCteV2
      DFe_NetCore_Domain_Resources_ProductInvoiceInboundResource = Data.define(:automatic_manifesting, :company_id, :created_on, :modified_on, :start_from_date, :start_from_nsu, :status) do
