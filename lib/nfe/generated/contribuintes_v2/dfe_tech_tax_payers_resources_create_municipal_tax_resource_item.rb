...
module Nfe
  module Generated
    module ContribuintesV2
      DFeTech_TaxPayers_Resources_CreateMunicipalTaxResourceItem = Data.define(:auth_issue_value, :city, :company_registry_number, :email, :environment, :federal_tax_determination, :iss_rate, :last_rps_sent, :legal_nature, :login_name, :login_password, :municipal_tax_determination, :regional_tax_number, :rps_number, :rps_serial_number, :special_tax_regime, :tax_number) do
