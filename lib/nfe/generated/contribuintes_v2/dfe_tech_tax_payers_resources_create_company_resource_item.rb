...
module Nfe
  module Generated
    module ContribuintesV2
      DFeTech_TaxPayers_Resources_CreateCompanyResourceItem = Data.define(:account_id, :address, :federal_tax_number, :municipal_tax_number, :name, :tax_regime, :trade_name) do
