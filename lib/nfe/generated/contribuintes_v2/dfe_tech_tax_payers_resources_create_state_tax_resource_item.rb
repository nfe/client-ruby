...
module Nfe
  module Generated
    module ContribuintesV2
      DFeTech_TaxPayers_Resources_CreateStateTaxResourceItem = Data.define(:code, :environment_type, :number, :processing_details, :security_credential, :serie, :special_tax_regime, :tax_number, :type) do
